...
function shoreditch_widgets_init() {
	register_sidebar( array(
		...
		'before_title'  => '<h2 class="widget-title ican-font-hindsiliguri-bold">',
		'after_title'   => '</h2>',
	) );
...
function wpdocs_excerpt_more( $more ) {
    return sprintf( '...<a class="read-more" href="%1$s"><button class="ican-base-btn ican-font-metropolis-semibold">%2$s</button></a>',
